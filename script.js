        ...
        for (let i = 0; i < line.length; i++) {
            if (line[i] === 9) {
                ...
                if (shiftCount === 0) {
                    out += '<div class="clearfix"></div>';
                    shiftCount++;
                    out += '<div class="keyboard-key shift-left" data="'+ line[i] +'"> Shift </div>';
                } else {
                    out += '<div class="keyboard-key shift-right" data="'+ line[i] +'"> Shift </div>';
                }
            } else if (line[i] === 17) {
                if (ctrlCount === 0) {
                    out += '<div class="clearfix"></div>';
                    ctrlCount++;
                    out += '<div class="keyboard-key ctrl-left" data="'+ line[i] +'"> Ctrl </div>';
                } else {
                    out += '<div class="keyboard-key ctrl-right" data="'+ line[i] +'"> Ctrl </div>';
                }
            } else if (line[i] === 18) {
                if (altCount === 0) {
                    altCount++;
                    out += '<div class="keyboard-key alt-left" data="'+ line[i] +'"> Alt </div>';
                } else { 
                    out += '<div class="keyboard-key alt-right" data="'+ line[i] +'"> Alt </div>';
                }
            } else if (line[i] === 91) {
